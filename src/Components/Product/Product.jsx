                ...
                <div className="product__container _container">
                    <div className="product__header">
                        ...
                        <div className="product__block">
                            <div className="product__articles">Артикул: <b>238125</b></div>
                    ...
                    <section className="reviews">
                        <div className="reviews__wrap-title">
                            ...
                            <div className='reviews__wrap-btn'>
                                <span className='reviews__btn'
                                    onClick={showMore}
                                >Еще отзывы</span>
                                <span className='reviews__btn' onClick={hideReview}>Свернуть отзывы</span>
                                {!showForm ? (
